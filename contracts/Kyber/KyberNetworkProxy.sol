...
contract KyberNetworkProxy is KyberNetworkProxyInterface, SimpleNetworkInterface, Withdrawable, Utils2 {
    ...
    event ExecuteTrade(address indexed trader, ERC20Interface src, ERC20Interface dest, uint actualSrcAmount, uint actualDestAmount);
    ...
    function calculateTradeOutcome (uint srcBalanceBefore, uint destBalanceBefore, ERC20Interface src, ERC20Interface dest,
        address destAddress)
