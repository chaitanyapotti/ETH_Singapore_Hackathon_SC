...
contract LiquidityConversionRates is ConversionRatesInterface, LiquidityFormula, Withdrawable, Utils {
    ...
    function LiquidityConversionRates(address _admin, ERC20Interface _token) public {
    ...
    function recordImbalance(
        ERC20Interface conversionToken,
        int buyAmountInTwei,
    ...
    function getRateWithE(ERC20Interface conversionToken, bool buy, uint qtyInSrcWei, uint eInFp) public view returns(uint) {
        uint deltaEInFp;
