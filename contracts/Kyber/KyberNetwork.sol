...
contract KyberNetwork is Withdrawable, Utils2, KyberNetworkInterface {
    ...
    event ListReservePairs(address reserve, ERC20Interface src, ERC20Interface dest, bool add);
    ...
    function listPairForReserve(address reserve, ERC20Interface token, bool ethToToken, bool tokenToEth, bool add)
        public onlyAdmin
    {
        require(isReserve[reserve]);
    ...
    function getExpectedRate(ERC20Interface src, ERC20Interface dest, uint srcQty)
        public view
    ...
    function findBestRate(ERC20Interface src, ERC20Interface dest, uint srcAmount) public view returns(uint obsolete, uint rate) {
    ...
    function searchBestRate(ERC20Interface src, ERC20Interface dest, uint srcAmount) public view returns(address, uint) {
        uint bestRate = 0;
        uint bestReserve = 0;
    ...
    function findBestRateTokenToToken(ERC20Interface src, ERC20Interface dest, uint srcAmount) internal view
    ...
    function listPairs(address reserve, ERC20Interface token, bool isTokenToEth, bool add) internal {
        uint i;
    ...
    event KyberTrade(address srcAddress, ERC20Interface srcToken, uint srcAmount, address destAddress, ERC20Interface destToken,
        uint destAmount);
    ...
    function calcActualAmounts (ERC20Interface src, ERC20Interface dest, uint srcAmount, uint maxDestAmount, BestRateResult rateResult)
    ...
    function validateTradeInput(ERC20Interface src, uint srcAmount, ERC20Interface dest, address destAddress)
        internal
        view
        returns(bool)
    {
